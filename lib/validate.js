...
module.exports = function() {
	...
	return function * (next) {
		...
		this.checkBody = function(key) {
			...
			// support koa-better-body default fields
			// https://github.com/tunnckoCore/koa-better-body
			// @TODO detect if module is loaded and read config fields name
			if (typeof body.fields === "object" && typeof body.files === "object") {
			  	body = body.fields;
			}
